...
\ustcsetup{
  title              = {容器化持续集成与持续交付流水线调度系统设计与实现},
  title*             = {Design and Implementation of a Containerized Continuous Integration and Continuous Delivery Pipeline Scheduling System},
  author             = {},
  author*            = {},
  speciality         = {软件工程},
